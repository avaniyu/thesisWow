...
namespace TextTest
{
    public partial class MainForm : System.Windows.Forms.Form
    {
        ...
        {
            if ((_o.AutoStop && (_td != null && _td.TrialNo == _o.StopAfter))|| countPhrase == countPhraseMax)
            {
            ...
            else // no auto-stopping
            {
                ...
                string presented = _phrases.GetPhraseAt(countPhrase);
                countPhrase++;
